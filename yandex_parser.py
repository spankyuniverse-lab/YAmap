...
KZ_SETTLEMENTS: dict[str, str] = {
    ...
    "Сарыкемер": "71.5200,42.8000",
    "Аса": "71.2700,42.9300",
    "Бауыржан Момышулы": "70.8300,43.2900",
    "Кулан": "72.7200,42.9200",
    "Мойынкум": "72.9500,44.2800",
    "Толе би": "73.7300,43.6800",
    "Луговой": "72.7000,42.9800",
    "Ойтал": "72.0500,42.9300",
    "Гродеково": "71.0000,43.1800",
    "Михайловка": "71.1000,42.8500",
    "Кенес": "71.0500,42.7000",
    "Акыртобе": "71.9000,43.0500",
    "Новоджамбул": "71.4500,42.9500",
    "Шолдала": "71.3000,43.2500",
    "Жансугуров": "79.5000,45.4500",
    "Уштобе": "77.9800,45.2400",
    "Сарыозек": "77.4300,44.3600",
    "Балпык би": "78.9300,45.0200",
    "Карабулак": "78.5000,45.0500",
    "Кабанбай": "80.8300,45.8300",
    "Достык": "82.4700,45.2500",
    "Лепсы": "80.7200,46.2500",
    "Коктума": "81.7000,46.0200",
    "Жаналык": "79.3000,45.3000",
    "Бактыбай": "79.7000,45.0000",
    "Карашилик": "78.8000,45.3000",
    "Акши": "78.6000,44.9000",
    ...
    "Амангельды": "65.2000,50.1800",
    "Аулиеколь": "64.1000,52.2800",
    "Денисовка": "61.7500,52.4300",
    "Торгай": "63.5000,49.6300",
    "Камысты": "62.9000,52.5500",
    "Карабалык": "61.9500,53.7200",
    "Карасу": "64.9000,53.0800",
    "Сарыколь": "66.4700,52.4700",
    "Тарановское": "65.7300,52.7700",
    "Узунколь": "64.4300,54.0300",
    "Федоровка (Костанай)": "62.6800,53.6200",
    "Караменды": "64.2800,51.6500",
    "Качар": "62.9500,53.2000",
    "Октябрьский": "65.5000,52.5000",
    ...
    "Актогай (Павлодар)": "79.0000,51.3000",
    ...
    "Жетысай": "68.2300,40.7700",
    "Атакент": "68.3300,40.8200",
    "Шаульдер": "68.3200,42.8000",
    "Аксукент": "69.3200,42.3500",
    "Казыгурт": "69.4000,41.7800",
    "Шолаккорган": "69.4800,43.8000",
    "Темирлановка": "69.1500,42.5800",
    "Шаян": "69.4000,42.9700",
    "Манкент": "69.6000,42.5000",
    "Карабулак (Сайрам)": "69.7700,42.5000",
    "Бадам": "69.6000,42.4000",
    "Т. Рыскулов": "70.3000,42.5300",
    "Жибек жолы": "69.2000,41.5000",
...
KZ_BORDER: list[tuple[float, float]] = [
    (48.95, 46.35), (48.5, 47.5), (47.4, 47.95), (46.35, 48.45),
    (46.5, 49.5), (47.4, 50.15), (48.6, 50.7), (48.0, 51.15),
    (48.4, 51.55), (50.8, 51.55), (52.1, 51.6), (53.3, 51.25),
    (54.5, 51.1), (55.7, 51.1), (56.7, 51.35), (57.7, 51.05),
    (58.6, 51.05), (59.7, 50.85), (60.9, 50.7), (60.8, 51.6),
    (60.55, 52.5), (61.2, 53.15), (61.75, 53.98), (62.9, 54.25),
    (63.9, 54.45), (64.9, 54.6), (65.7, 54.9), (66.7, 55.2),
    (67.7, 55.45), (68.7, 55.55), (69.8, 55.4), (70.9, 55.2),
    (71.9, 54.8), (72.8, 54.4), (73.6, 54.05), (74.4, 53.8),
    (75.5, 53.75), (76.9, 54.1), (78, 53.4), (79, 52.7),
    (80.1, 52.1), (80.75, 51.5), (81.2, 51.15), (82, 50.95),
    (82.7, 50.9), (83.6, 50.8), (84.8, 50.45), (85.8, 50.1),
    (86.65, 49.95), (87.5, 49.25), (87, 48.8), (86.45, 48.35),
    (85.95, 47.9), (85.75, 47.4), (85.65, 46.85), (84.8, 46.35),
    (83.6, 46.5), (82.9, 46.6), (82.7, 46.15), (82.65, 45.7),
    (82.75, 45.25), (82.2, 44.95), (81.4, 44.8), (80.9, 44.7),
    (80.55, 44.2), (80.75, 43.7), (80.95, 43.2), (80.75, 42.8),
    (80.55, 42.4), (80.3, 42.1), (79.8, 42.5), (79, 42.65),
    (78.1, 42.7), (77.2, 42.7), (76.5, 42.65), (75.9, 42.8),
    (75.25, 42.95), (74.62, 42.95), (74.2, 42.92), (73.6, 42.7),
    (72.9, 42.7), (72.0, 42.62), (71.5, 42.35), (71.1, 42.15),
    (70.85, 42), (70.35, 41.7), (69.85, 41.45), (69.4, 41.4),
    (69.22, 41.38), (68.95, 41.35), (68.75, 41.1), (68.6, 40.8),
    (68.4, 40.5), (68.05, 40.6), (67.9, 40.9), (67.75, 41.2),
    (67, 41.6), (66, 41.95), (64.6, 42.5), (63, 43),
    (61.5, 43.4), (60.2, 43.7), (59, 43.9), (57.7, 44.2),
    (56.4, 44.6), (56.1, 43.6), (56.05, 42.6), (55.6, 41.85),
    (54.5, 41.7), (53.4, 41.55), (52.35, 41.45), (52.7, 42.2),
    (52.5, 42.85), (51.6, 43.2), (51, 43.65), (50.5, 44.1),
    (49.95, 44.72), (50.9, 44.72), (51.1, 45.1), (52, 45.45),
    (53.1, 45.35), (53.4, 46), (52.6, 46.35), (51.7, 46.6),
    (50.6, 46.4), (49.7, 46.3),
]
...
KZ_ROUTES: list[tuple[str, list[tuple[float, float]]]] = [
    ("М-36 граница РФ—Костанай—Астана—Караганда—Балхаш—Алматы", [
        (61.65, 53.98), (62.05, 53.75), (62.68, 53.62), (63.62, 53.21),
        (63.9, 52.75), (64.1, 52.36), (64.63, 52.45), (65.5, 52.2),
        (66.4, 51.96), (67.34, 51.91), (68.36, 51.81), (69.83, 51.63),
        (70.7, 51.4), (71.43, 51.13), (71.95, 50.85), (72.4, 50.6),
        ...
        (74.7, 44.6), (75.35, 44.28), (75.9, 44.05), (76.38, 43.9),
        (76.5, 43.55), (76.62, 43.2), (76.93, 43.26),
    ]),
    ("М-38 граница РФ (Омск)—Павлодар—Семей—Майкапшагай", [
        (75.2, 53.95), (75.32, 53.45), (76.1, 52.9), (76.95, 52.29),
        (77.35, 51.9), (77.75, 51.48), (78.5, 51.05), (79.4, 50.75),
    ...
    ("М-32 граница РФ (Самара)—Уральск—Актобе—Кызылорда—Шымкент", [
        (50.2, 51.22), (51.37, 51.2), (52.2, 51.2), (52.99, 51.17),
        (54.08, 51.09), (55.2, 50.85), (56.3, 50.6), (57.17, 50.28),
        (58.43, 50.25), (59.3, 50.1), (60.1, 49.92), (60.5, 49.3),
        (61, 48.8), (61.2, 48), (61.3, 47.4), (61.67, 46.8),
        (61.95, 46.4), (62.15, 45.86), (62.75, 45.7), (63.31, 45.62),
    ...
    ("А-2 Шымкент—Тараз—Кордай—Алматы", [
        (69.59, 42.32), (70, 42.45), (70.35, 42.54), (70.9, 42.7),
        (71.37, 42.9), (72.1, 42.95), (72.72, 42.92), (73.18, 42.87),
        (73.7, 42.95), (74.2, 43), (74.71, 43.05), (74.95, 43.2),
        (75.21, 43.53), (75.78, 43.35), (76.31, 43.23), (76.93, 43.26),
    ]),
    ("А-351 Алматы—Шелек—Жаркент—Хоргос", [
        (76.93, 43.26), (77.5, 43.4), (78.25, 43.59), (78.8, 43.75),
        (79.35, 43.95), (79.73, 44.09), (80, 44.16), (80.42, 44.21),
    ]),
    ("А-1 Астана—Кокшетау—Петропавловск", [
        (71.43, 51.13), (71, 51.7), (70.94, 51.99), (70.42, 52.63),
        (70.19, 52.93), (69.39, 53.28), (69.4, 53.9), (69.43, 54.51),
        (69.14, 54.87),
    ]),
    ("А-3 Алматы—Талдыкорган—Аягоз—Усть-Каменогорск", [
        (76.93, 43.26), (77.06, 43.87), (77.5, 44), (77.75, 44.2),
    ...
    ("Астана—Экибастуз—Павлодар", [
        (71.43, 51.13), (72.2, 51.35), (73.1, 51.62), (74, 51.6),
        (74.8, 51.66), (75.32, 51.72), (76, 51.95), (76.95, 52.29),
    ]),
    ("Караганда—Жезказган—Кызылорда", [
        (73.09, 49.8), (72.4, 49.55), (72, 49.1), (71.64, 48.68),
        (70.8, 48.45), (70, 48.2), (69.1, 48), (68.4, 47.9),
        (67.71, 47.78), (67.3, 47.1), (66.9, 46.4), (66.4, 45.7),
        (66, 45.2), (65.51, 44.85),
    ]),
    ("Актобе—Кандыагаш—Атырау", [
        (57.17, 50.28), (57.33, 49.9), (57.42, 49.47), (57, 49.3),
        (56.49, 49.14), (55.87, 48.69), (55, 48.75), (53.92, 48.87),
        (53.6, 48.35), (53.35, 47.65), (52.98, 47.53), (51.92, 47.11),
    ]),
    ("Атырау—Бейнеу—Актау", [
        (51.92, 47.11), (52.98, 47.53), (53.5, 47.2), (54.02, 46.95),
        (54.6, 46.5), (54.9, 46), (55.2, 45.32), (54.4, 44.8),
        (53.55, 44.34), (52.8, 44.25), (52.11, 44.17), (51.7, 43.9),
        (51.16, 43.65),
    ]),
    ("Уральск—Индербор—Атырау", [
        (51.37, 51.2), (51.3, 50.7), (51.17, 50.2), (51.5, 49.6),
        (51.8, 49.1), (51.78, 48.55), (51.7, 48.1), (51.58, 47.67),
        (51.92, 47.11),
    ]),
    ("Семей—Усть-Каменогорск", [
        (80.23, 50.41), (80.9, 50.25), (81.55, 49.96), (82.1, 49.95),
        (82.61, 49.95),
    ]),
    ("Усть-Каменогорск—Риддер", [
        (82.61, 49.95), (82.95, 50.1), (83.3, 50.24), (83.51, 50.34),
    ]),
    ("Таскескен—Урджар—Бахты", [
        (80.77, 47.25), (81.2, 47.2), (81.62, 47.09), (82.02, 46.78),
    ...
    ("Кокшетау—Рузаевка—Костанай", [
        (69.39, 53.28), (68.5, 53.05), (67.8, 52.95), (66.97, 52.82),
        (66, 52.95), (65.1, 53.1), (64.3, 53.2), (63.62, 53.21),
    ]),
    ("Павлодар—Баянаул—Караганда", [
        (76.95, 52.29), (76, 51.95), (75.82, 51.45), (75.7, 50.79),
        (74.85, 50.45), (74.1, 50.15), (73.72, 49.99), (73.09, 49.8),
    ]),
    ("Шымкент—Казыгурт—граница Узбекистана", [
        (69.59, 42.32), (69.45, 42), (69.38, 41.76), (69.2, 41.5),
        (69.05, 41.33),
    ]),
    ("Актобе—Мартук—граница РФ (Оренбург)", [
        (57.17, 50.28), (56.9, 50.55), (56.5, 50.74), (55.8, 50.85),
        (55.1, 50.97),
    ]),
    ("Атырау—Ганюшкино—граница РФ (Астрахань)", [
        (51.92, 47.11), (51.17, 47.02), (50.4, 46.9), (49.8, 46.75),
        (49.27, 46.6), (48.9, 46.7),
    ]),
    ("Бейнеу—Тажен (граница Узбекистана)", [
        (55.2, 45.32), (55.6, 45.1), (56, 44.95),
    ]),
