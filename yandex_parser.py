...
UZ_BBOX = (55.9, 37.1, 73.2, 45.7)     # (lon_min, lat_min, lon_max, lat_max)
...
""",
    ...
    if args.list_cities:
        ...
        print(f"\n  ИТОГО {len(KZ_CITIES_ALL)} городов (--cities all)"
              ...
              f" = {len(KZ_PLACES_ALL)} (--cities макс)")
        print(f"  Трассы:              {len(KZ_ROUTES)} магистралей (--routes)")
